...
void ComparisonObjectsByMomentsOfTheirContours()//http://robocraft.ru/blog/computervision/867.html
{
	IplImage *original = 0, *templ = 0;

	// имя картинки задаётся первым параметром
	char* filename = "../data/find.bmp";
	// получаем картинку
	...
	char* filename2 = "../data/templ3.bmp";
	// получаем картинку
