//
// позвол€ет подобрать параметры
// Rmin, Rmax, Gmin, Gmax, Bmin, Bmax
// дл€ выделени€ нужного объекта по цвету
//
// robocraft.ru
//
...
// дл€ хранени€ каналов RGB
IplImage* rgb = 0;
IplImage* r_plane = 0;
IplImage* g_plane = 0;
IplImage* b_plane = 0;
// дл€ хранени€ каналов RGB после преобразовани€
IplImage* r_range = 0;
IplImage* g_range = 0;
IplImage* b_range = 0;
...
int FindColor()//http://robocraft.ru/blog/computervision/365.html
{
	...
	while (true) {
		...
		// показываем результат порогового преобразовани€
